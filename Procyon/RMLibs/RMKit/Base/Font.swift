//==========================================================================
//this struct holds base information of font

import UIKit

enum RMFontStyle :String{
    case boldItalic
    case light
    case italic
...
struct Font{
    var defaultSize = UIFont.systemFontSize
    var smallFontSize = UIFont.smallSystemFontSize
    var labelFontSize = UIFont.labelFontSize
    var buttonFontSize = UIFont.buttonFontSize
    //==============================================
    //MaterialIcons is a font of google's Material Design Icon font
    //Ionicons  とは違うのだよ　Ionicons　とは。
    ...
    //==============================================
    //Ionicons is a font useful Icon font
    //そのうち使うためのクラスつくる。
    //これはそのままじゃ使えない。
    //ク、クラウン。Ioniconsには生文字列から生成する性能は無い。気の毒だが・・・。
    //Eventually i'll make class to use Ionicons font. wait just
    struct IonIcons {
        static func font(_ size:CGFloat)->UIFont{
    ...
    //==============================================
    //Roboto is a font made by google 
    //Roboto is used in Android
    struct Roboto{
        static func font(_ size:CGFloat,style:RMFontStyle = .light)->UIFont{
            switch style {
            case .boldItalic:
    ...
    struct HelveticaNune {
        static func font(_ size:CGFloat,style:RMFontStyle = .normal)->UIFont{
            //全部対応しているただ一つのフォントHelveticaNune
            return UIFont(name: "Helvetica-\(style)", size: size)!
        }
    }
    struct SnellRoundhand {
        static func font(_ size:CGFloat,style:RMFontStyle = .normal)->UIFont{
            switch style {
            case .normal:
